...
const Tiktok = ({ tiktokVideoLikes, tiktokFollowers }) => {
  return (
    <div>
      <Nav />
      <div id='menu-trigger'>
      ...
      <div id='wrapper'>
        <div id='inner'>
          ...
          <div id='page'>
            ...
            <div id='content'>
              <h2>About eBay Gift Card Generator</h2>

              <p>
                Gift Card Rebel is the #1 place for Free eBay Gift Cards,
                created by outstanding bunch of geeks all around the world. We
                want to help you get your favorite apps and games for free,
                because we think that they are highly overpriced!
              </p>

              <p>
                Since the beginning, we have been the best online generator.
                With a large collection of eBay Gift Cards, we generate hundreds
                of codes every day and strive to provide the best service to our
                visitors.
              </p>

              <h2>How to use eBay Gift Card Generator</h2>

              <p>
                Select the desired value by pressing the card you want and it
                will be generated in less than a minute. When your eBay Gift
                Card Code is generated, you can simply copy it and use on your
                eBay Redeem page. Get unused codes directly and effortlessly
                from your favorite web browser.
              </p>

              <h2>How does eBay Gift Card Generator works</h2>

              <p className=''>
                We don't generate new codes and put them to eBay databases like
                other groups do, which can lead to ban of your account. This
                online generator is clean to use and undetected by eBay server.
                We connect to their databases through our newly developed
                system, generate random codes, and search database if they exist
                and are unused.
              </p>
            </div>
          </div>
